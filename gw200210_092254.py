# -*- coding: utf-8 -*-
"""GW200210_092254.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1P7p1G10ucu_Ce1oh_p3FCBV-iJ_ePdv7
...
class PoissonBurst(BaseModel):
    ...
    def _loglikelihood(self):
        ...
        # generate the signal
        times = self.times
        signal = self.get_signal(times, finalmass, mass1, mass2)
    ...
    @staticmethod
    def get_signal(times, finalmass, mass1, mass2):
...
signal = PoissonBurst.get_signal(times, finalmass, mass1, mass2)
